  ...
  <section className="" style={{margin:"0px",padding:"0px auto"}}>
      <div className="container" style={{marginTop:"0px",padding:"0px auto"}}>
        ...
        <div className="productinfo">
          <p style={{color: "#1da912", align: "center",textTransform: "Capitalize"}}>Rugged drone with 5 kg payload  </p>
        </div>
        <p>Drone manufactured with high-strength carbon fibers and Aluminum 7075-grade materials. Drone is integrated with PX4 opensource autopilot system and is intended to carry a maximum of 5 kg payload.</p>
        <br />
        <br />
