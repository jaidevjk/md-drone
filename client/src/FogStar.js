  ...
  <section className="" style={{margin:"0px",padding:"0px auto"}}>
      <div className="container" style={{marginTop:"0px",padding:"0px auto"}}>
        ...
        <div className="productinfo">
          <p style={{color: "#1da912", align: "center",textTransform: "Capitalize"}}>An eye in the sky </p>
        </div>
        <p>As the name suggests, a thermal fogger uses heat to vaporize a fogging solution. In most cases this liquid is an insecticide. It sprays the solution out of the nozzle of the fogger in the form of a mist or fog. When the fogging solution enters the heating assembly, it goes through a coil that is a very high temperature. This vaporizes the insecticides from its liquid state. This vapour is then sprayed through the nozzle at the end of the foggerin the form of thick fog.</p>
        <br />
        <br />
