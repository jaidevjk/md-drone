 ...
 <div style={{marginTop:"0px"}}><ResponsiveAppBar /> </div>                       
  <section className="" style={{margin:"0px",padding:"0px auto"}}>
      <div className="container" style={{marginTop:"0px",padding:"0px auto"}}>
        ...
        <p>Ikshana drone is manufactured with a metal matrix composite, airframe arms and landing gears are foldable and equipped with PX4 autopilot system and 2 axis gimbal camera with 1080 pixel live transmission.</p>
        <br />
        <br />
